...
//server be express js application and agent is out http request i.e. used to send the connection requests
let server, agent;
...
describe("Todo test suite", () => {
  ...
  test("responds with json at /todos", async () => { //Create a new todo
